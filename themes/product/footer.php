	<?php include (get_template_directory() . '/library/options/options.php'); ?>
		...
		<?php endif; ?>
		<div id="footer">
						<div id="footer-navigation">	<a href="<?php echo get_option('home'); ?>"><?php _e( 'Copyright', 'product' ) ?> &copy;<?php echo gmdate(__('Y')); ?> <?php get_bloginfo( 'name' ); ?></a><a href="#site-wrapper"><?php _e('Go back to top &uarr;', 'product'); ?></a></div>
			<?php if($bp_existed == 'true') : ?>
