...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	<head profile="http://gmpg.org/xfn/11">
		...
		<?php $slide_auto = get_option('dev_product_slide_auto'); ?>
	...
	<body <?php body_class() ?>>
		...
		<div id="header">
				<div id="search-bar">
						<?php
							/*$sitedescription = bloginfo( 'description' );
						...
						?>
					<h2><?php echo stripslashes(bloginfo( 'description' )); ?></h2>
				...
				if($logo_on == "no" && $square_logo == "yes"){
					...
					<h1 class="square-header"><a href="<?php echo get_option('home') ?>" title="<?php _e( 'Home', 'product' ) ?>"><?php echo bloginfo('name'); ?></a></h1>
				<?php
				}
				...
				?>
					<h1><a href="<?php echo get_option('home') ?>" title="<?php _e( 'Home', 'product' ) ?>"><?php echo stripslashes(bloginfo( 'name' )); ?></a></h1>
				<?php
				}
			...
			<div class="clear"></div>
				...
				<?php
					locate_template(array('/library/components/navigation.php'), true );
					if($bp_existed == 'true'){
						locate_template(array('/library/components/buddypress/buddypress-navigation.php'), true );
					}
