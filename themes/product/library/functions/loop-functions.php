...
function bp_wpmu_blogpage_loop(){
		...
		query_posts("cat=&showposts=$max_num_post&paged=$paged");

		while ( have_posts() ) : the_post();?>
		<div class="post" id="post-<?php the_ID(); ?>">
			<div class="author-box">
				<?php echo get_avatar( get_the_author_meta( 'user_email' ), '50' ); ?>
				<p><?php _e( 'by ', 'product' ) ?><?php the_author_link();  ?></p>
			</div>
			<div class="post-content">
				...
				<p class="date"><?php the_time('M j Y') ?> <em><?php _e( 'in', 'product' ) ?> <?php the_category(', ') ?> <?php _e( 'by ', 'product' ) ?><?php the_author_link();  ?></em></p>
				<div class="entry">
			...
			$_post = &get_post($post->ID); $classname = ($_post->iconsize[0] <= 128 ? 'small' : '') . 'attachment'; // This lets us style narrow icons specially ?>
				...
				<div class="post" id="post-<?php the_ID(); ?>">
					...
					<div class="entry">
						...
						<?php the_content( __('<p class="serif">Read the rest of this entry &rarr;</p>', 'product' ) ); ?>
