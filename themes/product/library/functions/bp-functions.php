...
function bp_dtheme_enqueue_scripts() {
	...
	$params = array(
		'my_favs'           => __( 'My Favorites', 'product' ),
		'accepted'          => __( 'Accepted', 'product' ),
		'rejected'          => __( 'Rejected', 'product' ),
		'show_all_comments' => __( 'Show all comments for this thread', 'product' ),
		'show_all'          => __( 'Show all', 'product' ),
		'comments'          => __( 'comments', 'product' ),
		'close'             => __( 'Close', 'product' ),
...
function bp_dtheme_show_notice() {
	...
	<div id="message" class="updated fade">
		<p><?php printf( __( 'Theme activated! This theme contains <a href="%s">custom header image</a> support and <a href="%s">sidebar widgets</a>.', 'product' ), admin_url( 'themes.php?page=custom-header' ), admin_url( 'widgets.php' ) ) ?></p>
	</div>
