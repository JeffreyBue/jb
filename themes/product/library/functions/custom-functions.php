...
register_nav_menus( array(
	'primary' => __( 'Primary Navigation', 'product' ),
) );
...
$output = __('There is no excerpt because this is a protected post.', 'product');
return $output;
}
}
...
function signup_button(){
	...
	$signupfeat_buttontext = get_option('dev_product_signupfeat_buttontext');
	$signupfeat_buttontext_custom = get_option('dev_product_signupfeat_buttontext_custom');
