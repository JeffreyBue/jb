...
if ( $customer_orders ) : ?>
	...
	<h3 class="headline"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></h3><span class="line"></span><div class="clearfix"></div>

	<table class="shop_table standard-table my_account_orders">
						...
						<?php
							...
							if ($actions) {
								foreach ( $actions as $key => $action ) {
									echo '<a href="' . esc_url( $action['url'] ) . '" class="button light ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
								}
							}
						?>
					</td>
