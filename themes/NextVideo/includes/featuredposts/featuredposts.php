    ...
    class Themater_FeaturedPosts
    {
        ...
        var $defaults = array(
            ...
            'custom_default_slides' => array(
                ...
                '5' => array('link' => '#', 'title' => 'This is default featured slide 6 title', 'content' => 'You can completely customize the featured slides from the theme theme options page. You can also easily hide the slider from certain part of your site like: categories, tags, archives etc.')
            )
        );
